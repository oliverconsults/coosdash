...
5) CRM Update:
   ...
   - Wenn du **Artefakte** erzeugst (Ergebnis für Oliver):
     - **Nur** klickbare Ergebnisse veröffentlichen: **URL** (z.B. Prototyp/Ansicht) oder **gerenderte Dateien** (PDF/IMG/DOC/XLS/PPT/CSV).
     - **Keine Systempfade, keine Programm-/Code-Dateien** als Attachment (Oliver ist nicht auf dem Server).
     - Erlaubte Dateitypen: **url, pdf, img (png/jpg/jpeg/webp/gif), doc/docx, excel (xls/xlsx), ppt/pptx, csv**.
     ...
     - Das erzeugt einen Link und zeigt ihn im UI unter „Attachments“.
