...
if ($f === '' || !preg_match('/^(job_\d+_node_\d+_(prompt|response)|project_setup_\d{8}_\d{6}_[a-z0-9\-]+_(prompt|response))\.txt$|^project_setup_\d{8}_\d{6}_[a-z0-9\-]+_meta\.md$/', $f)) {
