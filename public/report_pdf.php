...
$wrapped .= ".brand{ display:flex; flex-direction:column; gap:2px; }\n";
$wrapped .= ".brandRow{ display:flex; align-items:center; gap:12px; }\n";
$wrapped .= ".brandRow img{ height:30px; width:auto; }\n";
